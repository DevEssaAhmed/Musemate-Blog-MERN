  ...
  return (
    <div>
      ...
      <section className='relative bg-dark-hard px-5'>
        <div className='container grid grid-cols-12 mx-auto py-10 md:pb-20 md:leading-normal lg:place-items-center'>
          <div className='col-span-12 lg:col-span-6'>
            <h2 className='text-white font-roboto font-bold text-2xl md:text-4xl md:text-center lg:text-left'>
              Get our stories delivered from us to your inbox weekly
            </h2>
            <div className='w-full max-w-[494px] mt-12 space-y-3 mx-auto md:space-y-0 md:flex space-x-2 lg:mx-0'>
              <input
                type='text'
            ...
            <p className='text-dark-light text-sm leading-7 mt-6 md:text-center md:text-base lg:text-left'>
              ...
              If we received after 9pm wil get a response the following day
            </p>
          </div>
          <div className='col-span-12 lg:col-span-6 hidden md:block mb-[70px] md:order-first lg:order-last'>
            <div className='w-3/4 mx-auto relative'>
              <div className='w-1/2 h-1/2 bg-[#FC5A5A] rounded-lg absolute top-[10%] -right-[8%]'></div>
              <div className='w-1/2 h-1/2 bg-white opacity-[.06] rounded-lg absolute -bottom-[10%] -left-[8%]'></div>

              <div
                className={`w-full bg-white p-3 relative z-[1] rounded-xl   `}
              >
                <img
                  src={images.CtaImage}
                  alt=''
